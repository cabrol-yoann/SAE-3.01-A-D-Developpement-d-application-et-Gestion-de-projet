                  ...
                  <form action="../code/inscription.php" method="post">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-floating flex-fill mb-0">
                        <input type="text" name="nom" id="floatingName" class="form-control" placeholder="name">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-floating flex-fill mb-0">
                        <input type="email" name="email" id="floatingEmail" class="form-control" placeholder="name@example.com">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-floating flex-fill mb-0">
                        <input type="password" name="pasword" id="floatingPassword" class="form-control" placeholder="Password">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-floating flex-fill mb-0">
                        <input type="password" name="passwordRepeat" id="floatingRepeatPassword" class="form-control" placeholder="Password">
                    ...
                    <div class="form-check d-flex justify-content-center mb-5">
                      <input class="form-check-input me-2" type="checkbox" value="" id="floatingTerms">
